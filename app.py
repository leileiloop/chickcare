...
# -------------------------
# ENV VARS (set in Render or .env)
# -------------------------
# SECRET_KEY=f4e83d6a2c5b47bcb0a9e08f7f91d83d
...
# Normalize DB URL (some platforms give postgres://)
...
if POOL_AVAILABLE and ConnectionPool:
    try:
        ...
        app.logger.warning(f"Failed to create pool: {e}")
